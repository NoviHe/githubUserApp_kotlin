...
import com.noviherlambang.submission3githubuser.ui.viewmodel.FollowingViewModel
...
class FollowingFragment:Fragment(R.layout.fragment_follow) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        loadingShow(true)
        viewModel=
            ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(FollowingViewModel::class.java)
